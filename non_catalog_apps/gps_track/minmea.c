...
bool minmea_parse_gbs(struct minmea_sentence_gbs* frame, const char* sentence) {
    ...
    if(!minmea_scan(
           ...
           &frame->stddev))
        return false;
    if(memcmp(frame->type.sentence_id, "GBS", sizeof(frame->type.sentence_id))) return false;
...
bool minmea_parse_rmc(struct minmea_sentence_rmc* frame, const char* sentence) {
    ...
    if(!minmea_scan(
           ...
           &variation_direction))
        return false;
    if(memcmp(frame->type.sentence_id, "RMC", sizeof(frame->type.sentence_id))) return false;
...
bool minmea_parse_gga(struct minmea_sentence_gga* frame, const char* sentence) {
    ...
    if(!minmea_scan(
           ...
           &frame->dgps_age))
        return false;
    if(memcmp(frame->type.sentence_id, "GGA", sizeof(frame->type.sentence_id))) return false;
...
bool minmea_parse_gsa(struct minmea_sentence_gsa* frame, const char* sentence) {
    ...
    if(!minmea_scan(
           ...
           &frame->vdop))
        return false;
    if(memcmp(frame->type.sentence_id, "GSA", sizeof(frame->type.sentence_id))) return false;
...
bool minmea_parse_gll(struct minmea_sentence_gll* frame, const char* sentence) {
    ...
    if(!minmea_scan(
           ...
           &frame->mode))
        return false;
    if(memcmp(frame->type.sentence_id, "GLL", sizeof(frame->type.sentence_id))) return false;
...
bool minmea_parse_gst(struct minmea_sentence_gst* frame, const char* sentence) {
    ...
    if(!minmea_scan(
        ...
        return false;
    if(memcmp(frame->type.sentence_id, "GST", sizeof(frame->type.sentence_id))) return false;
...
bool minmea_parse_gsv(struct minmea_sentence_gsv* frame, const char* sentence) {
    ...
    if(memcmp(frame->type.sentence_id, "GSV", sizeof(frame->type.sentence_id))) return false;
    return true;
}
...
bool minmea_parse_vtg(struct minmea_sentence_vtg* frame, const char* sentence) {
    ...
    if(!minmea_scan(
           ...
           &c_faa_mode))
        return false;
    if(memcmp(frame->type.sentence_id, "VTG", sizeof(frame->type.sentence_id))) return false;
...
bool minmea_parse_zda(struct minmea_sentence_zda* frame, const char* sentence) {
    ...
    if(!minmea_scan(
           ...
           &frame->minute_offset))
        return false;
    if(memcmp(frame->type.sentence_id, "ZDA", sizeof(frame->type.sentence_id))) return false;
