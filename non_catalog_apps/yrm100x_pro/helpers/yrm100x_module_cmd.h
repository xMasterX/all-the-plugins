...
/**
 * File that handles the commands for the YRM100 module
 * @author frux-c
*/
...
static const uint8_t CMD_GET_WORK_AREA_DATA[] = {0xBB, 0x00, 0x08, 0x00, 0x00, 0x08, 0x7E};
static const uint8_t CMD_GET_TRANSMITTING_POWER_DATA[] = {0xBB, 0x00, 0xB7, 0x00, 0x00, 0xB7, 0x7E};
...
static const Command CMD_GET_WORK_AREA = {CMD_GET_WORK_AREA_DATA, sizeof(CMD_GET_WORK_AREA_DATA)};
static const Command CMD_GET_TRANSMITTING_POWER = {
    CMD_GET_TRANSMITTING_POWER_DATA,
    sizeof(CMD_GET_TRANSMITTING_POWER_DATA)};
