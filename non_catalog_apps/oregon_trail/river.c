...
static FordOutcome roll_ford(RiverState* r, const GameState* gs) {
    ...
    if(roll < w[0])
        ...
        outcome = FORD_DISASTROUS;
    else
        outcome = FORD_CATASTROPHIC;
    ...
    case FORD_SAFE:
        ...
        break;
    case FORD_ROUGH:
        r->food_lost = rng_range(20, 60);
        break;
    case FORD_DISASTROUS:
        r->food_lost = rng_range(40, 80);
        break;
    case FORD_CATASTROPHIC:
        r->food_lost = rng_range(60, 120);
        break;
    }
...
void river_draw(Canvas* c, const RiverState* r, const GameState* gs) {
    ...
    const char* seasons[] = {
        "", "Win", "Win", "Spr", "Spr", "Spr", "Sum", "Sum", "Sum", "Aut", "Aut", "Win", "Win"};
    ...
    char ferry_label[24];
    snprintf(
        ferry_label, sizeof(ferry_label), "  Take Ferry ($%d)", RIVERS[r->river_idx].ferry_cost);
