...
static void
    play_sequence(const struct GameState* game_state, const NotificationSequence* sequence) {
...
const NotificationSequence settings_confirm_sequence = {&message_note_c6, &message_delay_100, NULL};
