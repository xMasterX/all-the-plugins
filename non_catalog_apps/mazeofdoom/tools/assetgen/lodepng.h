...
struct LodePNGDecompressSettings {
    unsigned
        ignore_adler32; /*if 1, continue and don't give an error message if the Adler32 checksum is corrupted*/
...
typedef struct LodePNGInfo {
  ...
  */
    ...
    char**
        itext_langtags; /*language tag for this text's language, ISO/IEC 646 string, e.g. ISO 639 language tag*/
...
typedef struct LodePNGColorProfile {
    ...
    unsigned
        key; /*if true, image is not opaque. Only if true and alpha is false, color key is possible.*/
