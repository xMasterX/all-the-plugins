...
void specter_scene_about_on_enter(void* context) {
    ...
    widget_add_text_scroll_element(
        ...
        128,
        40,
        /* Controls first. Every binding in this app was documented only here,
         * below five paragraphs of prose, in the seventh item of the menu -
         * which is to say documented nowhere. Lines are kept to 21 characters
         * so the key map renders as a table instead of wrapping like prose. */
        "CONTROLS\n"
        "Sweep\n"
        "  OK       reset peak\n"
        "  hold OK  save it\n"
        ...
        " PEGGED meter maxed\n"
        " \n"
        "The mark across the dial is\n"
        "where READER begins at the\n"
        "sensitivity you have set.\n"
        " \n"
        ...
        "READER - with peak/avg field, contacts and\n"
        "how much of the time a carrier was up. Press\n"
        "OK to stop early and grade what it has; the\n"
        "card shows the length it was graded over.\n"
        "A run cut short before 10 s says TOO SHORT\n"
        "rather than CLEAN - finding nothing in one\n"
        "second is not evidence about a room, while\n"
        "finding something is, so TRACE and ACTIVE\n"
        "are never held back for being quick.\n"
        "Auto-logged.\n"
        " \n"
