...
const char* mfp_card_info_manufacturer_name(uint8_t vendor_id) {
    ...
    case 0x03:
        return "Hitachi, Ltd.";
    case 0x04:
        return "NXP Semiconductors Germany";
    case 0x05:
    ...
    case 0x10:
        return "LG-Semiconductors Co. Ltd.";
    case 0x11:
        return "Emosyn-EM Microelectronics";
    case 0x12:
        return "INSIDE Technology";
    case 0x13:
        return "ORGA Kartensysteme GmbH";
    case 0x14:
    ...
    case 0x1E:
        return "Magellan Technology Pty Limited";
    case 0x1F:
        return "Melexis NV BO";
    case 0x20:
    ...
    case 0x22:
        return "Transcore";
    case 0x23:
        return "Shanghai Belling Corp., Ltd.";
    case 0x24:
        return "Masktech Germany GmbH";
    case 0x25:
        return "Innovision Research and Technology Plc";
    case 0x26:
        return "Hitachi ULSI Systems Co., Ltd.";
    case 0x27:
        return "Yubico AB";
    case 0x28:
        return "Ricoh";
    ...
    case 0x2B:
        return "Dallas Semiconductor / Maxim";
    case 0x2C:
        return "Impinj, Inc.";
    case 0x2D:
...
const char* mfp_card_info_sak_type(uint8_t sak) {
    ...
    case 0x18:
        return "MIFARE Classic 4K / Plus 4K SL1";
    case 0x20:
        return "MFP SL3 / DESFire / SmartMX";
    case 0x28:
        return "JCOP30";
    case 0x38:
        return "MIFARE Classic 4K emulated";
    case 0x88:
...
void mfp_card_info_format(
    ...
    /* --- Card type (parsed from ATS historical bytes when available) --- */
    {
        ...
        if(ats_bytes && ats_len >= 3 && ats_bytes[0] == 0xC1) {
            ...
            if(card_type_code == 0x2)
                type_name = "MIFARE Plus";
            else if(card_type_code == 0x3)
                type_name = "MIFARE Ultralight";
            else if(card_type_code == 0x4)
    ...
    if(ats_bytes && ats_len >= 3 && ats_bytes[0] == 0xC1) {
        ...
        if(mem_code == 0x1)
            furi_string_set(val, "2K (16 sectors)");
        else if(mem_code == 0x2)
            furi_string_set(val, "4K (32 sectors)");
        else if(mem_code == 0x3)
            furi_string_set(val, "4K (40 sectors)");
        else
    ...
    if(version->uid_len > 0) {
        append_field(out, "Manufacturer", mfp_card_info_manufacturer_name(version->uid[0]));
    }
