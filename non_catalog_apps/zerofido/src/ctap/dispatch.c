...
static uint8_t zf_handle_selection(
    ZerofidoApp* app,
 ...
 * shape once called.
 */
uint8_t zf_ctap_dispatch_command(
    ZerofidoApp* app,
    ...
    case ZfCtapeCmdGetInfo: {
        ...
        status = zf_ctap_build_get_info_response(
            capabilities, pin_is_set, response_body, response_body_capacity, response_body_len);
        break;
    }
    ...
    case ZfCtapeCmdMakeCredential:
        ...
        status = zf_ctap_handle_make_credential(
            app,
            session_id,
            request_body,
            request_body_len,
    ...
    case ZfCtapeCmdGetAssertion:
        ...
        status = zf_ctap_handle_get_assertion(
            app,
            session_id,
            request_body,
            request_body_len,
    ...
    case ZfCtapeCmdGetNextAssertion:
        ...
        status = zf_ctap_assertion_queue_handle_next(
            app, session_id, response_body, response_body_capacity, response_body_len);
        break;
