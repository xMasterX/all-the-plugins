...
uECC_word_t uECC_vli_add(uECC_word_t *result, const uECC_word_t *left, const uECC_word_t *right,
                         wordcount_t num_words);
...
void uECC_vli_mult(uECC_word_t *result, const uECC_word_t *left, const uECC_word_t *right,
                   wordcount_t num_words);
...
/* Computes result = left^2 % mod.
   Currently only designed to work for mod == curve->p or curve_n. */
void uECC_vli_modSquare(uECC_word_t *result, const uECC_word_t *left, const uECC_word_t *mod,
                        wordcount_t num_words);
