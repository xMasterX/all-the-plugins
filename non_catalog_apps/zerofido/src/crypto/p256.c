...
static void zf_p256_public_from_xy(
    const uint8_t x[ZF_PUBLIC_KEY_LEN],
...
static void zf_p256_public_to_xy(
    const uint8_t public_key[ZF_PUBLIC_KEY_LEN * 2U],
...
bool zf_p256_compute_public_key(
