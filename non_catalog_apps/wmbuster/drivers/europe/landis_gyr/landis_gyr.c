...
const WmbusDriver wmbus_drv_lse_water = {
    .id = "lse-water",
    .title = "Landis+Staefa water",
    .mvt = k_mvt_lse,
    .decode = NULL,
};

/* Q-Heat 5 (LSE 0x23,0x04) */
static const WmbusMVT k_mvt_qheat5[] = {{"LSE", 0x23, 0x04}, {"LSE", 0x01, 0x08}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_qheat5 = {
    .id = "qheat5",
    .title = "Qundis Q-Heat 5",
    .mvt = k_mvt_qheat5,
    .decode = NULL,
};

/* Generic LGB / LGZ / LUG fallback */
static const WmbusMVT k_mvt_lg_fallback[] = {{"LGB", 0xFF, 0xFF}, {"LGZ", 0xFF, 0xFF}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_lg_fallback = {
    .id = "landis-gyr",
    .title = "Landis+Gyr meter",
    .mvt = k_mvt_lg_fallback,
    .decode = NULL,
};
