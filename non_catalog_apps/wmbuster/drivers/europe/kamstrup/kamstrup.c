...
const WmbusDriver wmbus_drv_kamstrup_flowiq = {
    .id = "kam-flowiq",
    .title = "Kamstrup flowIQ water",
    .mvt = k_mvt_flowiq,
    .decode = NULL,
};

/* OmniPower (electricity) and Carlo-Gavazzi-rebadge KAM 0x33,02. */
static const WmbusMVT k_mvt_omnipower[] = {{"KAM", 0x30, 0x02}, {"KAM", 0x33, 0x02}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_kamstrup_omnipower = {
    .id = "kam-omnipower",
    .title = "Kamstrup OmniPower",
    .mvt = k_mvt_omnipower,
    .decode = NULL,
};

/* Kampress — pressure sensor. */
static const WmbusMVT k_mvt_kampress[] = {{"KAM", 0x01, 0x18}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_kamstrup_kampress = {
    .id = "kam-press",
    .title = "Kamstrup pressure",
    .mvt = k_mvt_kampress,
    .decode = NULL,
};
