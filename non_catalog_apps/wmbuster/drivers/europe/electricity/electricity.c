...
/* ABB B23/B24 */
static const WmbusMVT k_mvt_abb[] = {{"ABB", 0x20, 0x02}, {"ABB", 0xFF, 0x02}, {{0}, 0, 0}};
...
/* EBZ wMBus electric. */
static const WmbusMVT k_mvt_ebz[] = {{"EBZ", 0x01, 0x02}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_ebzwmbe = {
    .id = "ebzwmbe",
    .title = "EBZ wMBus elec",
    .mvt = k_mvt_ebz,
    .decode = NULL,
};
...
static const WmbusMVT k_mvt_esys[] =
    {{"ESY", 0x11, 0x02}, {"ESY", 0x30, 0x37}, {"ESY", 0xFF, 0xFF}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_esys_wm = {
    .id = "esyswm",
    .title = "EasyMeter elec",
    .mvt = k_mvt_esys,
    .decode = NULL,
};

/* Carlo Gavazzi EM24 */
static const WmbusMVT k_mvt_em24[] = {{"GAV", 0x00, 0x02}, {"GAV", 0xFF, 0x02}, {{0}, 0, 0}};
...
static const WmbusMVT k_mvt_iem3000[] =
    {{"SEC", 0x13, 0x02}, {"SEC", 0x15, 0x02}, {"SEC", 0x18, 0x02}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_iem3000 = {
    .id = "iem3000",
    .title = "Schneider iEM3000",
    .mvt = k_mvt_iem3000,
    .decode = NULL,
};
...
static const WmbusMVT k_mvt_ime[] =
    {{"IME", 0x1D, 0x02}, {"IME", 0x66, 0x02}, {"IME", 0xFF, 0xFF}, {{0}, 0, 0}};
...
static const WmbusMVT k_mvt_eltako[] = {{"ELT", 0x01, 0x02}, {"ELT", 0xFF, 0xFF}, {{0}, 0, 0}};
...
static const WmbusMVT k_mvt_gss[] = {{"GSS", 0x01, 0x02}, {"GSS", 0xFF, 0xFF}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_gransystems = {
    .id = "gransystems",
    .title = "Gran-Systems elec",
    .mvt = k_mvt_gss,
    .decode = NULL,
};
