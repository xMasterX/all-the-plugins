...
const WmbusDriver wmbus_drv_itron_water = {
    .id = "itron-water",
    .title = "Itron BM+M water",
    .mvt = k_mvt_itron,
    .decode = NULL,
};

static const WmbusMVT k_mvt_itron_heat[] = {{"ITW", 0x00, 0x04}, {"ITW", 0xFF, 0x04}, {{0}, 0, 0}};
const WmbusDriver wmbus_drv_itron_heat = {
    .id = "itron-heat",
    .title = "Itron heat",
    .mvt = k_mvt_itron_heat,
    .decode = NULL,
};

static const WmbusMVT k_mvt_itron_gas[] = {{"ITW", 0xFF, 0x03}, {{0}, 0, 0}};
