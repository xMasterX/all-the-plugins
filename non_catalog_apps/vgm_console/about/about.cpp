...
VideoGameModuleConsoleAbout::VideoGameModuleConsoleAbout(ViewDispatcher* viewDispatcher)
    : widget(nullptr)
    ...
    widget_add_text_scroll_element(
        ...
        128,
        64,
        "Flipper Zero console for the\nVideo Game Module\n\n\n\nwww.github.com/jblanked");
    view_set_previous_callback(widget_get_view(this->widget), callbackToSubmenu);
    view_dispatcher_add_view(
        viewDispatcher, VideoGameModuleConsoleViewAbout, widget_get_view(this->widget));
}
