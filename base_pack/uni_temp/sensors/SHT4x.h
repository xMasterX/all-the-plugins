...
*/
#ifndef UNITEMP_SHT4x
#define UNITEMP_SHT4x

#include "../unitemp.h"
#include "../sensors.h"
extern const SensorModel SHT4x;
/**
 * @brief Allocating memory and setting initial values ​​for the SHT4x sensor
 *
...
/**
 * @brief SHT4x sensor initialization
 *
