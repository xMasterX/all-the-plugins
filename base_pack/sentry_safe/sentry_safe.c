...
static const uint8_t qr_code_github_bits[] = {
    ...
    ,
...
static void sentry_safe_render_callback(Canvas* const canvas, void* ctx) {
    ...
    if(state->status > 0) {
        canvas_draw_str_aligned(
            canvas, 64, 30, AlignCenter, AlignBottom, status_texts[state->status]);
    } else {
        ...
        if(furi_message_queue_get(event_queue, &event, 100) == FuriStatusOk) {
            ...
            if(event.input.type == InputTypePress) {
                ...
                if(state->status == 2) {
                    ...
                    send_request(
                        state->is_primary ? 0x75 : 0x76,
                        state->code); // Send code overwritecommand
                    furi_delay_ms(500);
